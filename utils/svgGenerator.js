class SVGGenerator {
    ...
    static generateGraffitiText(text, style) {
        ...
        // Create two gradients for a more complex effect
        const gradientId1 = `textGradient1_${Math.random().toString(36).substr(2, 9)}`;
        const gradientId2 = `textGradient2_${Math.random().toString(36).substr(2, 9)}`;
        ...
        return `
            <defs>
                ...
                <linearGradient id="${gradientId1}" gradientTransform="rotate(${gradientAngle})">
                    <stop offset="0%" stop-color="#ffffff" />
                    <stop offset="100%" stop-color="#cccccc" />
                </linearGradient>
                <linearGradient id="${gradientId2}" gradientTransform="rotate(${gradientAngle + 45})">
                    <stop offset="0%" stop-color="#ffffff" />
            ...
            <g>
                ...
                <!-- Overlay text with second gradient for depth -->
                <text 
                    x="${x}" 
                    y="${y}" 
                    font-size="${fontSize}px" 
